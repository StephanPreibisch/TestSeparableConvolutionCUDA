...
void test3d()
{
    ...
    *d_Buffer;
    ...
    printf("Allocating and initializing host arrays...\n");
    h_Kernel    = (float *)malloc(KERNEL_LENGTH * sizeof(float));
    h_Input     = (float *)malloc(imageW * imageH * imageD * sizeof(float));
    h_Buffer    = (float *)malloc(imageW * imageH * imageD * sizeof(float));
    h_OutputCPU = (float *)malloc(imageW * imageH * imageD * sizeof(float));
    h_OutputGPU = (float *)malloc(imageW * imageH * imageD * sizeof(float));
    srand(200);
    ...
    for (unsigned i = 0; i < imageW * imageH * imageD; i++)
    {
        h_Input[i] = (float)(rand() % 16);
    }
    ...
    printf("Allocating and initializing CUDA arrays...\n");
    checkCudaErrors(cudaMalloc((void **)&d_Input,   imageW * imageH * imageD * sizeof(float)));
    checkCudaErrors(cudaMalloc((void **)&d_Output,  imageW * imageH * imageD * sizeof(float)));
    checkCudaErrors(cudaMalloc((void **)&d_Buffer , imageW * imageH * imageD * sizeof(float)));
    ...
    sdkStopTimer(&hTimer);
    double gpuTime = 0.001 * sdkGetTimerValue(&hTimer) / (double)iterations;
    printf("convolutionSeparable3d, Throughput = %.4f MPixels/sec, Time = %.5f s, Size = %u Pixels, NumDevsUsed = %i, Workgroup = %u\n",
